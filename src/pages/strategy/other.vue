<template>
  <section class="h-full w-full text-[#072867]">
    <div class="relative">
      <img src="@/assets/images/strategy/other/banner.png" alt="" srcset=""
        class="h-[20vh] md:h-170 w-full object-cover">
      <div class="text-white absolute bottom-0 w-full px-4 sm:px-6 md:px-8 lg:px-16 xl:px-30">
        <Container type="extra-wide">
          <div class="px-10">
            <p class="text-sm md:text-5xl font-bold">
              {{ t('pages.other.title1') }}
            </p>
    ...
    <Container type="extra-wide">
      <div class="px-10 py-6 sm:py-8 md:py-10">
        ...
        <p
          ...
          {{ t('pages.other.services.title') }}</p>
    ...
    <div class="bg-[#EBEFF4] ">
      <Container type="extra-wide">
        <div
          class="px-10 flex flex-col lg:flex-row justify-center items-center  py-8 sm:py-10 md:py-12 lg:py-16 xl:py-20 gap-6 sm:gap-8 md:gap-12 lg:gap-20 xl:gap-30">
          <div class="w-full lg:w-1/2 flex justify-center">
            <img src="@/assets/images/strategy/other/image.png" alt="" srcset=""
          ...
          <div class="w-full lg:w-1/2 lg:pr-10">
            ...
            <p
              ...
              {{ t('pages.other.value.content') }}<br />
              {{ t('pages.other.value.content2') }}
            </p>

            <p class="text-base sm:text-lg md:text-xl my-6 sm:my-8 md:my-10 leading-relaxed">
              {{ t('pages.other.value.subDesc') }}
            </p>
          </div>
        </div>
      </Container>
